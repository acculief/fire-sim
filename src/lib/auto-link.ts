...
const KEYWORD_LINKS: { keyword: string; href: string }[] = [
  ...
  { keyword: "バリスタFIRE", href: "/guide/fire-barista/" },
  ...
  { keyword: "FIREとは", href: "/guide/what-is-fire/" },
  { keyword: "FIRE必要資産", href: "/guide/how-to-calculate-fire-number/" },
  { keyword: "必要資産額", href: "/guide/how-to-calculate-fire-number/" },
  { keyword: "地域別FIRE", href: "/guide/fire-by-region/" },
  { keyword: "地方移住", href: "/guide/fire-by-region/" },
  { keyword: "子育てとFIRE", href: "/guide/fire-with-family/" },
  { keyword: "30代からのFIRE", href: "/guide/fire-by-age-30/" },
  { keyword: "40代からのFIRE", href: "/guide/fire-by-age-40/" },
  { keyword: "FIRE失敗", href: "/guide/fire-mistakes/" },
  { keyword: "年金とFIRE", href: "/guide/fire-and-pension/" },
  { keyword: "公的年金", href: "/guide/fire-and-pension/" },
  { keyword: "不動産投資", href: "/guide/fire-real-estate/" },
  { keyword: "夫婦でFIRE", href: "/guide/fire-couple-strategy/" },
  { keyword: "共働き", href: "/guide/fire-couple-strategy/" },
  { keyword: "FIRE メンタル", href: "/guide/fire-mental/" },
];
