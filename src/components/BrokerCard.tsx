  ...
  return (
    <div className="rounded-lg border border-white bg-white p-4">
      ...
      <a
        ...
        aria-label={`${b.name}で無料で口座開設`}
        className="mt-3 inline-block rounded-lg bg-accent-600 px-5 py-3 text-sm font-bold text-white transition-colors hover:bg-accent-700"
      >
